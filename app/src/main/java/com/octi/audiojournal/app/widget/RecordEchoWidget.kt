package com.octi.audiojournal.app.widget
...
import com.octi.audiojournal.app.MainActivity
import com.octi.audiojournal.app.navigation.ACTION_CREATE_ECHO
...
class RecordEchoWidget: GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        val recordNewEcho = context.getString(R.string.record_new_audio)
        provideContent {
            GlanceTheme {
                Column(
